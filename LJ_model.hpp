...
public:
    ...
    void    get_single_particle_contributions_not_owner(const vector<xyz> & coords, const xyz & selected_atom_coords, const xyz & boxdim, double & energy_selected, xyz & stress_selected);
...
void LJ_model::get_single_particle_contributions_not_owner(const vector<xyz> & coords, const xyz & selected_atom_coords, const xyz & boxdim, double & energy_selected, xyz & stress_selected)
{
    energy_selected   = 0;
    stress_selected.x = 0;
    stress_selected.y = 0;
